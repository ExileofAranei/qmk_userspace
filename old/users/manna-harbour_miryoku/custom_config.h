...
// Маппинг для всех слоёв — крайние столбцы пустые
...
// Базовый слой — с дополнительными клавишами по краям
...
LAYOUT_split_3x6_3( \
    ...
    OS_LSFT, K20, K21, K22, K23, K24,   K25, K26, K27, K28, K29, KC_RBRC, \
                       K32, K33, K34,   K35, K36, K37                     \
)

// Базовый слой QWERTY — ж вместо э в среднем ряду
